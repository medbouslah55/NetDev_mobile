...
public class AfficherMenuSolo extends BaseForm {
    ...
    public AfficherMenuSolo(Resources res, int idRegime, int idMenu) {
        ...
        //Add image
        String url1 = "http://127.0.0.1:8001/admin/img/menu/"+ p.getMatinImg();
        String url2 = "http://127.0.0.1:8001/admin/img/menu/"+ p.getDejeunerImg();
        String url3 = "http://127.0.0.1:8001/admin/img/menu/"+ p.getDinnerImg();
